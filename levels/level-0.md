...
- [ DONE ] You have a GitHub repository called `Project-TV-Show` which is not a fork of this repo.
- [ DONE ] The `index.html` page on your GitHub project contains your name and GitHub username.
- [ DONE ] Your project is deployed to Netlify at `cyf-USERNAME-tv.netlify.app`.
- [ DONE ] Your deployed project has your name and GitHub username in its title.
